...
public class UserController {
	...
	@ApiResponses(value = {@ApiResponse(description = "User Saved Successfully",responseCode = "201"),@ApiResponse(description = "Unable To Save User To Database",responseCode = "409")})
	@PostMapping
	...
	@ApiResponses(value = {@ApiResponse(description = "User Updated Successfully",responseCode = "200"),@ApiResponse(description = "Unable To Updated User To Database",responseCode = "409")})
	@PutMapping
	...
	@ApiResponses(value = {@ApiResponse(description = "User Found Successfully",responseCode = "200"),@ApiResponse(description = "Unable To Find User for Provided userId...",responseCode = "404")})
	@GetMapping("/{userId}")
	...
	@ApiResponses(value = {@ApiResponse(description = "User Found Successfully",responseCode = "200"),@ApiResponse(description = "Unable To Find User for Provided empId...",responseCode = "404")})
	...
	@ApiResponses(value = {@ApiResponse(description = "User Deleted Successfully",responseCode = "200"),@ApiResponse(description = "Unable To Delete User for Provided userId...",responseCode = "404")})
	...
	@ApiResponses(value = {@ApiResponse(description = "User Found Successfully",responseCode = "200"),@ApiResponse(description = "Unable To Find User for Provided Phone Number...",responseCode = "404")})
	...
	@ApiResponses(value = {@ApiResponse(description = "User Found Successfully",responseCode = "200"),@ApiResponse(description = "Unable To Find User for Provided email...",responseCode = "404")})
	...
	@ApiResponses(value = {@ApiResponse(description = "User Found Successfully",responseCode = "200"),@ApiResponse(description = "Unable To Find User for Provided UserRole...",responseCode = "404")})
	...
	@ApiResponses(value = {@ApiResponse(description = "User Found Successfully",responseCode = "200"),@ApiResponse(description = "Unable To Find User for Provided UserCategory...",responseCode = "404")})
	...
	@ApiResponses(value = {@ApiResponse(description = "User Found Successfully",responseCode = "200"),@ApiResponse(description = "Unable To Find User for Provided UserStatus...",responseCode = "404")})
	...
	@ApiResponses(value = {@ApiResponse(description = "Batch Timings Fetched Successfully",responseCode = "200"),@ApiResponse(description = "Unable to fetch the Batch Timings of user",responseCode = "404")})
	...
	@ApiResponses(value = {@ApiResponse(description = "User Status Updated Successfully to IN_ACTIVE",responseCode = "200"),@ApiResponse(description = "Can't Update UserStatus To IN_ACTIVE",responseCode = "404")})
	@PatchMapping("/{userId}")
